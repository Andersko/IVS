...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QSize(860, 455))
        MainWindow.setMaximumSize(QSize(860, 455))
        ...
        self.verticalLayoutWidget.setGeometry(QRect(9, 9, 842, 401))
        ...
        self.OutputLabel.setMinimumSize(QSize(840, 165))
        self.OutputLabel.setMaximumSize(QSize(840, 165))
        font = QFont()
        font.setPointSize(36)
        self.OutputLabel.setFont(font)
        self.OutputLabel.setLayoutDirection(Qt.LeftToRight)
        self.OutputLabel.setFrameShape(QFrame.Box)
        self.OutputLabel.setFrameShadow(QFrame.Plain)
        self.OutputLabel.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        self.OutputLabel.setMargin(15)
        ...
        self.gridLayout.addWidget(self.Button_Sqrt, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Four, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_C, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_One, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Divide, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Six, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Percent, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Five, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Two, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Three, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Zero, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Dot, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.Button_Hint, 2, 5, 1, 1)
        ...
        self.horizontalLayout.addWidget(self.Button_Equals)
